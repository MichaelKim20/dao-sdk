...
The `Client` class that can be imported via `@bosagora/sdk-client` allows you to perform operations that apply to all DAOs, regardless of the plugins they use.
